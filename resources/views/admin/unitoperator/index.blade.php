                                        ...
                                        <div class="row g-2">
                                            <div class="col mb-0">
                                                ...
                                                <div class="input-group input-group-merge form-password-toggle mb-2">
                                                    <input type="password" class="form-control" name="password" id="basic-default-password1"
                                                        placeholder="Your Password"
                                                        aria-describedby="basic-default-password1" required />
                                            ...
                                            <div class="col mb-0">
                                                ...
                                                <div class="input-group input-group-merge form-password-toggle mb-2">
                                                    <input type="password" class="form-control" name="password_confirmation"" id="basic-default-password1"
                                                        placeholder="Your Password"
                                                        aria-describedby="basic-default-password1" required />
                                                    <span class="input-group-text cursor-pointer"><i
                                                            data-feather="eye"></i></span>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#Modal1-{{ $user->id }}"
                                                class="btn btn-primary btn-sm" data-bs-placement="top"
                                                title="Update data" data-bs-toggle="tooltip">
                                                <i data-feather='edit'></i>
                                            </button>
                                            <form method="POST" action="{{ route('operator.destroy', $user->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" id="confirm-text" class="btn btn-danger btn-sm"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="hapus data"><i data-feather='trash-2'></i></button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
