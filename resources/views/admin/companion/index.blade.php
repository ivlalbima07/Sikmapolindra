...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Sikma |</span> Instruktur/Pendamping Dudi</h4>
        @if (session('status'))
                    ...
                    <tbody>
                        @foreach ($companions as $companion)
                            <tr>
                                ...
                                <td class="align-top">{{ $companion->nama }}</td>
                                <td class="text-center align-top">{{ $companion->jabatan_dudi }}</td>
                                <td class="text-center align-top">{{ $companion->no_telefon }}</td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12 mb-1 mb-sm-0">
                                    ...
                                    <select class="select2 form-select" id="pendidikan_terakhir"
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" id="edit_name" name="nama" placeholder="Masukan Nama" required />
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="edit_email">Email</label>
                                    <input type="email" class="form-control" id="edit_email" name="email" placeholder="Masukan email" required />
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="edit_phone">No Telefon</label>
                                    <input type="text" class="form-control" id="edit_phone" name="no_telefon" placeholder="0895547624361" required />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                <input type="text" class="form-control" id="edit_position" name="jabatan_dudi" placeholder="Masukan Jabatan" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-12 mb-1 mb-sm-0">
                                <label class="form-label" for="edit_last_education">Pendidikan Terakhir</label>
                                <select class="select2 form-select" id="edit_last_education" name="pendidikan_terakhir" required>
                                    <option value="" hidden>Pilih pendidikan terakhir</option>
                                    <option value="SD">SD</option>
                                    <option value="SMP">SMP</option>
                                    <option value="SMA">SMA</option>
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                <input type="text" class="form-control" id="edit_expertise" name="keahlian" placeholder="Masukan Keahlian" required />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $('#modaledit').on('show.bs.modal', function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    modal.find('input[name="no_telefon"]').val(data.no_telefon);
                    modal.find('select[name="dudi_id"]').val(data.dudi_id);
                    modal.find('input[name="jabatan_dudi"]').val(data.jabatan_dudi);
                    modal.find('select[name="pendidikan_terakhir"]').val(data.pendidikan_terakhir);
                    modal.find('input[name="keahlian"]').val(data.keahlian);
                }
            });
        });
    });
