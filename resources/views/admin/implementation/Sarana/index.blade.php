...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Sikma |</span> DATA DUDI SARANA</h4>
                        ...
                        @foreach ($datakerjasama as $index => $kerjasama)
                            @foreach ($kerjasama->itemKerjasama as $item)
                                <tr>
                                    ...
                                    <td class="align-top">
                                        <div>
                                            <button type="button" onclick="location.href='{{ route('isi.sarana', $item->id) }}'" class="btn btn-success btn-sm">
