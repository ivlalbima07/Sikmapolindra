                            ...
                            <tr>
                                ...
                                <td class="align-top">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('isi-sarana.show', $sarana->id) }}" class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Show data">
                                            <i data-feather="eye"></i>
                                        </a>
                                        <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="{{ $sarana->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete data">
...
@section('scripts')
    ...
    $('.btn-delete').on('click', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        var url = `{{ route('isi-sarana.destroy', ':id') }}`.replace(':id', id);
