...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Invoice /</span>ISI DATA TENAGA PENDIDIK/TENAGA AHLI DARI
            DUNIA KERJA (TENAGA PENDIDIK TAMU)</h4>
                                        ...
                                        <div class="col-md-5 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="itemname"
                                                    aria-describedby="itemname" placeholder="Masukan Nama" />
                                            </div>
                                        </div>
                                        <div class="col-md-5 col-12">
                                            <div class="mb-1">
                                                <label for="nameBasic" class="form-label">Foto/dokumen
                                    ...
                                    <div class="row d-flex align-items-end">
                                        <div class="col-md-5 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="string" class="form-control" id="itemname"
                                                    aria-describedby="itemname" placeholder="Masukan Nama" />
                                            </div>
                                        </div>
