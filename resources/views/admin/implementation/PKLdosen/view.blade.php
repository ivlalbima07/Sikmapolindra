                        ...
                        <div class="row g-3 invoice-spacing">
                            ...
                            <div class="col">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="fw-bolder">Biaya Per Dosen</td>
                                            <td>:</td>
                                            <td>{{ number_format($pkldosen->biaya_per_dosen, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bolder">Biaya dari Dunia Kerja</td>
                                            <td>:</td>
                                            <td>{{ number_format($pkldosen->biaya_dari_dunia_kerja, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bolder">Biaya dari Satuan Pendidikan</td>
                                            <td>:</td>
                                            <td>{{ number_format($pkldosen->biaya_dari_satuan_pendidikan, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bolder">Biaya dari Pemerintah Daerah</td>
                                            <td>:</td>
                                            <td>{{ number_format($pkldosen->biaya_dari_pemerintah_daerah, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bolder">Biaya dari Pemerintah Pusat</td>
                                            <td>:</td>
                                            <td>{{ number_format($pkldosen->biaya_dari_pemerintah_pusat, 2) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
