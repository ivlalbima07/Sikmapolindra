                            ...
                            <tr>
                                ...
                                <td class="align-top">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('isiPenyerapan.show', $item->id) }}" class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Show data">
...
@section('scripts')
    ...
    $('.btn-delete').on('click', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        var url = `{{ route('isiPenyerapan.destroy', ':id') }}`.replace(':id', id);
