...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Sikma |</span>ISI DATA SERTIFIKASI KOMPETENSI -ASOSIASI
            PENGELASAN INDONESIA (API / IWS)</h4>
    ...
    <!-- Modal 1-->
    <div class="modal fade" id="modalToggle" aria-labelledby="modalToggleLabel" data-bs-backdrop="static" tabindex="-1" style="display: none"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="my-1">
                        <div class="mb-1">
                            <label class="form-label" for="basicSelect1">Penyelenggara</label>
                            <select class="form-select" id="basicSelect1" data-bs-toggle="pill" aria-expanded="true">
                                <option value="" hidden>Pilih</option>
                                <option class="dropdown-item">Sertifikasi Dari Dudi</option>
                                <option class="dropdown-item">Sertifikasi Dari BNSP</option>
                                <option class="dropdown-item" value="lainnya">Lainya</option>
                            </select>
                        </div>
                        <div id="otherOrganizer">
                            <label for="label-form">Nama Penyelenggara Lainnya</label>
                    ...
                    <div class="my-1">
                        <div class="mb-0">
                            <label class="form-label" for="basicSelect2">Masa Berlaku</label>
                            <select class="form-select" id="basicSelect2" data-bs-toggle="pill" aria-expanded="true">
                                <option value="" hidden>Pilih masa berlaku</option>
                                <option class="dropdown-item">1 tahun</option>
                                <option class="dropdown-item">2 tahun</option>
                                <option class="dropdown-item" value="lainnya2">lainnya</option>
                            </select>
                        </div>
                        <div id="otherOrganizer2">
                            <label for="label-form">Masa Berlaku Lainnya (Dalam Tahun)</label>
                            <input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="my-1">
                        <div class="col mb-0">
                            <label for="emailBasic" class="form-label">Tanggal Mulai Berlaku</label>
                            <input type="date" class="form-control invoice-edit-input date-picker" />
                        </div>
                    </div>
                    <div class="my-1">
                        <div class=" mb-0">
                            <label class="form-label" for="basicSelect">Peserta</label>
                    ...
                    <div class="">
                        <div class=" mb-0">
                            <label class="form-label" for="numeral-formatting">Biaya Sertifikasi Per</label>
