...
@section('content')
    <div class="card p-2">
        ...
        <div class="d-flex justify-content-end"> <button class="btn btn-success rounded-pill " data-bs-toggle="modal"
                data-bs-target="#klasifikasi" type="submit"><i class="bx bx-plus-circle"></i>
    ...
    <!-- Modal klasifikasi -->
    <div class="modal fade" id="klasifikasi" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
